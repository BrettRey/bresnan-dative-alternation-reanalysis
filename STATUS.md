...
**Next action:** Draft the *Linguistics Vanguard* cover letter disclosing the related CLLT submission and stating the separation of research questions; decide whether to trim the manuscript to the 3,000--4,000 word target or accept the length risk; prepare non-anonymous admin/title-page material and a submitted-version archive snapshot.
